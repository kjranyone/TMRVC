# TMRVC VC 学習計画 (Teacher + 蒸留)

> Merged from: `docs/design/training-plan.md` + `docs/design/phase1a-pipeline.md`
...
## Appendix A: Phase 1a 実行手順書

> Originally from: `docs/design/phase1a-pipeline.md`
>
> Created: 2026-02-21
...
#### A.4.1 設定 (configs/train_teacher.yaml Phase 1a)
