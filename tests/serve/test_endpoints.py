...
def test_tts_import_integrity(client, monkeypatch):
    ...
    def mock_tts(self, phonemes, speaker_embed, style, cfg_scale=1.5, temperature=0.8, language_id=0, pace=1.0, hold_bias=0.0, boundary_bias=0.0, max_frames=1500, dialogue_context=None, acting_intent=None, phrase_pressure=0.0, breath_tendency=0.0):
