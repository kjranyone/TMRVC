...
def main(argv: list[str] | None = None) -> None:
    ...
    max_steps = args.max_steps if args.max_steps is not None else file_cfg.get("max_steps", 100_000)
    ...
    checkpoint_dir = args.checkpoint_dir if args.checkpoint_dir is not None else Path(file_cfg.get("checkpoint_dir", "checkpoints"))
